...
localStorage.setItem("resultCoin", coin);
    ...
    localStorage.setItem("stage1Score",score);
...
console.log("保存後coin =", localStorage.getItem("coin"));
    ...
    const best = Number(localStorage.getItem("stage1Best")) || 0;

if(score > best){

    localStorage.setItem("stage1Best",score);

}

    if(score >= 8){

        localStorage.setItem("stage1Clear","true");
