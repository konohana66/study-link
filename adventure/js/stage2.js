...
localStorage.setItem("resultCoin", coin);
    ...
    localStorage.setItem("stage2Score",score);
...
console.log("保存後coin =", localStorage.getItem("coin"));
    ...
    const best = Number(localStorage.getItem("stage2Best")) || 0;

if(score > best){

    localStorage.setItem("stage2Best",score);

}

    if(score >= 8){

        localStorage.setItem("stage2Clear","true");

    }

    localStorage.setItem("resultStage", "stage2");
